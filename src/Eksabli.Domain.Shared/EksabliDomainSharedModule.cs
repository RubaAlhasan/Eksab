...
public class EksabliDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        EksabliGlobalFeatureConfigurator.Configure();
        EksabliModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<EksabliDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<EksabliResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Eksabli");

            options.DefaultResourceType = typeof(EksabliResource);
        ...
        {
            options.MapCodeNamespace("Eksabli", typeof(EksabliResource));
        });
    }
}
