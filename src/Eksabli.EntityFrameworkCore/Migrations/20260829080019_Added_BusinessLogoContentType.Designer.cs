...
namespace Eksabli.Migrations
{
    ...
    [Migration("20260829080019_Added_BusinessLogoContentType")]
    partial class Added_BusinessLogoContentType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eksabli.Notifications.NotificationMessage", b =>
                {
                    ...
                    b.ToTable("AppNotificationMessages", (string)null);
                });

            modelBuilder.Entity("Eksabli.Notifications.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Eksabli.Platform.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Eksabli.Platform.SupportTicketMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSupportTicketMessages", (string)null);
                });
            ...
            modelBuilder.Entity("Eksabli.Platform.Category", b =>
                {
                    b.HasOne("Eksabli.Platform.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Eksabli.Platform.SupportTicketMessage", b =>
                {
                    b.HasOne("Eksabli.Platform.SupportTicket", null)
                        .WithMany("Messages")
