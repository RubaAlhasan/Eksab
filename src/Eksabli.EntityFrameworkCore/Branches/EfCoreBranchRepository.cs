...
public class EfCoreBranchRepository : EfCoreRepository<EksabliDbContext, Branch, Guid>, IBranchRepository
{
    public EfCoreBranchRepository(IDbContextProvider<EksabliDbContext> dbContextProvider)
        : base(dbContextProvider)
    {
    }

    public async Task<(List<Branch> Items, int TotalCount)> GetListAsync(
    ...
    protected virtual IQueryable<Branch> ApplyFilter(IQueryable<Branch> query, string? filterText)
    {
